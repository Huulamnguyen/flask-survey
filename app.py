...
def pick_survey():
    ...
    # don't let them re-take a survey untile cookie times out.
...
@app.route("/complete")
def complete():
    """Survey complete. Thank you and list responses"""
    ...
    # Set cookie noting this survey is done so they can not re-take it.
